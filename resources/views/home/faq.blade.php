		...
		<div class="col-sm-6">
		  <div class="accordion-container">
			  ...
			  <div class="accordion_title">
				...
				<div class="content">
				  <p class="bottom20">If you are a registered user of Opectrade, please enter your email and password in the appropriate fields at the top of the website and click the "Login to Account" button. You will be redirected to your account automatically as soon as you have done the above.</p>
				</div>
			  </div>
			  <div class="accordion_title">
			  ...
			  <div class="accordion_title">
				...
				<div class="content">
				  <p class="bottom20">To make investments you should register with Opectrade, create an account and then you can make your deposit. All the investments are made in your personal account after login</p>
				</div>
			  </div>
			</div>
		</div>
