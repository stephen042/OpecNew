            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="contact_detail padding-bottom">
                        ...
                        <p class="bottom30">Want to work with us or need more details about our platform, you can fill
                            the form below to get in touch with us. We have a team of seasoned customer care agents who
                            are there round the clock to make sure we serve you at any point in time you need our
                            attention</p>
                        <p class="bottom20">Our innovative pricing, pooled liquidity, and execution algorithm to seek
                            the best price help remove the hassles of trading on a crypto Exchange. Our experts takes
                            care of all the Works for you.</p>
                        <h3 class="bottom20">Our Contacts</h3>
                        <p>We made several channels available to make it quick and easy to get in touch with us at any
                            given time. All of the channels are available on a 24/7 base</p>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="address">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="callus padding-bottom" method="POST" id="contact-form">
                        ...
                        <button type="submit" class="btn-green border_radius" id="btnContact">Send Message <i
