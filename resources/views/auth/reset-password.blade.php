        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <form id="registerForm1" action="{{ route('admin.reset.password', [$email, $token]) }}" method="POST"
                        class="login-form">
                        ...
                        <div class="form-group d-flex">
                            ...
                            <input name="password_confirmation" type="Password" class="form-control rounded-left"
                                placeholder="Confirm password" required>
                        </div>


                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-primary rounded submit px-3">Change
                                Password</button>
                        </div>
